...
UI.aspectRatioAdjustment = function () {
...
UI.BottomSection = function () {
    ScriptsPane.createScripts(frame);
};

UI.addProjectInfo = function () {
    UI.info = newHTML('div', 'info', frame);
    UI.info.setAttribute('id', 'projectinfo');
    var infobox = newHTML('div', 'infobox fade', frame);
    infobox.setAttribute('id', 'infobox');
    UI.okclicky = newHTML('div', 'paintdone', infobox);
...
UI.parentalGate = function (evt, callback) {
...
UI.shareBody = Localization.localize('SHARING_EMAIL_TEXT');
    ...
    function saveAndShare () {
        ...
        Project.prepareToSave(ScratchJr.currentProject, function () {
            ...
            IO.zipProject(ScratchJr.currentProject, function (contents) {
                ...
                iOS.sendSjrToShareDialog(IO.zipFileName, emailSubject, UI.shareBody, shareType, contents);
...
UI.handleTextFieldSave = function (dontHide) {
...
UI.finishTextFieldSave = function (dontHide) {
    var ti = UI.projectNameTextInput;
...
UI.showInfoBox = function (e) {
    ...
    setTimeout(function () {
        UI.okclicky.ontouchend = UI.hideInfoBox;
        UI.projectNameTextInput.onblur = function () {
            if (UI.isAndroid) {
...
UI.formatTime = function (unixtime) {
...
UI.hideInfoBox = function (e) {
    e.preventDefault();
    e.stopPropagation();
    ScratchJr.onBackButtonCallback.pop();

    // Prevent button thrashing
    UI.okclicky.ontouchend = null;
    setTimeout(function () {
        UI.info.ontouchend = UI.showInfoBox;
    }, 500);
...
UI.updateSpriteScroll = function () {
    var sc = gn('spritecc');
    var dy = sc.offsetTop;
    var p = sc.parentNode;
...
UI.resetSpriteLibrary = function () {
...
UI.spriteThumbsActions = function (e) {
...
UI.startSpriteScroll = function (e, tb) {
    if (ScratchJr.shaking) {
        ScratchJr.clearSelection();
    }
    if (!tb) {
...
UI.ignoreEvent = function (e) {
    e.preventDefault();
    e.stopPropagation();
};

UI.prepareToScroll = function (e) {
    e.preventDefault();
    e.stopPropagation();
    UI.spriteScolling(e, Events.dragthumbnail);
};

UI.stopScroll = function (e) {
    e.preventDefault();
    e.stopPropagation();
    UI.spriteScolling(e, Events.dragthumbnail);
};

UI.spriteScolling = function (e) {
    var pt = Events.getTargetPoint(e);
...
UI.spriteClicked = function (e, el) {
    e.preventDefault();
    e.stopPropagation();
    var t;
    if (window.event) {
...
UI.putInPaintEditor = function (e) {
    ScratchJr.unfocus(e);
...
UI.updatePageControls = function () {
...
UI.createFormForText = function (p) {
...
UI.createColorMenu = function (div) {
...
UI.createTextSizeMenu = function (div) {
...
UI.setMenuTextColor = function (t) {
...
UI.openFontSizeMenu = function (e) {
    e.preventDefault();
    e.stopPropagation();
