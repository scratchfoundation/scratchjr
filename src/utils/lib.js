export var frame;
export var eventDispatch = {};
export const isTablet = window.navigator.maxTouchPoints > 0;
...
export function initEvents () {
   // console.log ("initEvents in lib");
    eventDispatch["start"] = isTablet ? "ontouchstart" : "onmousedown";
    eventDispatch["move"] = isTablet ? "ontouchmove" : "onmousemove";
    eventDispatch["end"] = isTablet ? "ontouchend" : "onmouseup";
    eventDispatch["cancel"] = isTablet ? "ontouchcancel" : "onmouseout";
}
